...
// IN PROGRESS
var categorySubscriptionSchema = new mongoose.Schema({
    email: {
        type: String,
...
categorySubscriptionSchema.methods.createConfirmToken = function (category) {
...
var CategorySubscription = mongoose.model("CategorySubscription", categorySubscriptionSchema);
module.exports = CategorySubscription;
//# sourceMappingURL=categorySubscriptionSchema.js.map