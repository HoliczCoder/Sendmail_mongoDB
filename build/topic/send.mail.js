...
var sendMail = function () { return __awaiter(void 0, void 0, void 0, function () {
    var conn_1, channel, nameExchange, agrs, msg, topic, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                channel = _a.sent();
                nameExchange = "send_email";
                return [4 /*yield*/, channel.assertExchange(nameExchange, "topic", { durable: false })];
            case 3:
                _a.sent();
                ...
                return [4 /*yield*/, channel.publish(nameExchange, topic, Buffer.from(msg))];
            case 4:
                _a.sent();
